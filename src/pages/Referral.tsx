...
import { ArrowLeft, Gift, Users, Clock, CheckCircle, Sparkles, Crown, Copy, MessageCircle, Share2 } from 'lucide-react';
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t('referral.howItWorks.step3.description', 'Quando seu amigo faz a primeira transação, você ganha 500 XP + 7 dias Premium')}
                  </p>
                </div>
              </div>
            </CardContent>
